package com.eylulcan.moviefragment.data.service

import com.eylulcan.moviefragment.data.model.*
import com.eylulcan.moviefragment.data.model.MovieCredits
import com.eylulcan.moviefragment.data.model.MovieDetail
...
interface MovieAPI {
    ...
    suspend fun postMovieRating(
        ...
        @Body postRatingBodyEntity: PostRatingBodyEntity
